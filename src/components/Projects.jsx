        ...
        <section id="projects" className="text-gray-400 bg-gray-900 body-font">
            <div className="container px-5 py-10 mx-auto text-center lg:px-40">
                <div className="flex flex-col w-full mb-20">
                    ...
                    <h1 className="sm:text-4xl text-3xl font-medium title-font mb-4 text-white">Web Apps I've Built</h1>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">With close to a year of learning, researching and reading documentations, I've been able to build these projects with the technologies listed below.</p>
